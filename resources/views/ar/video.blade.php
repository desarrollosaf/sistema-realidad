...
<body>
  ...
  <script>
    ...
    const targetDirections = {
      ...
      8:  "{{ asset('aframe/examples/assets/murales/gifs/3-4-5-6-7(2).gif') }}",
      9:  "{{ asset('aframe/examples/assets/murales/gifs/3-4-5-6-7(2).gif') }}",
      10: "{{ asset('aframe/examples/assets/murales/gifs/3-4-5-6-7(2).gif') }}",
      11: "{{ asset('aframe/examples/assets/murales/gifs/3-4-5-6-7(2).gif') }}",
      12: "{{ asset('aframe/examples/assets/murales/gifs/3-4-5-6-7(2).gif') }}",
      13: "{{ asset('aframe/examples/assets/murales/gifs/3-4-5-6-7(2).gif') }}",
      14: "{{ asset('aframe/examples/assets/murales/gifs/3-4-5-6-7(2).gif') }}",
